    ...
    <section className="relative overflow-hidden">
      <Swiper
        ...
        pagination={{
          ...
          clickable: true,
          renderBullet: (index, className) => `<span class="${className} hero-pagination-bullet"></span>`,
        }}
            ...
            <div className="relative bg-gradient-to-r from-blue-900 via-blue-800 to-blue-700 text-white h-full overflow-hidden">
              ...
              <div className="container mx-auto px-4 relative z-10 h-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center h-full py-20">
                  <div className={`${language === "ar" ? "text-right" : "text-left"} animate-fade-in-up`}>
                  ...
                  <div className="relative animate-fade-in-right">
                    <div className="relative overflow-hidden rounded-2xl shadow-2xl">
                      <img
                        ...
                        alt={language === "ar" ? slide.title.ar : slide.title.en}
                    ...
                    >
                      ...
                      <div className="text-2xl font-bold">{language === "ar" ? slide.badge.ar : slide.badge.en}</div>
                    ...
                    >
                      <div className="flex items-center space-x-2 rtl:space-x-reverse">
                        ...
                        <span className="text-sm font-semibold">
                          {language === "ar" ? slide.quality.ar : slide.quality.en}
                        </span>
                      </div>
                    </div>
                  </div>
